  ...
  <div class="player"
    ...
    <div class="player-controls">
      <div class="player-buttons">
        ...
        <div class="player-btn">
          <span class="player-pause" @click="toggleStatus()">
            <i class="fa fa-play-circle" :class="{'fa-play-circle':isPause,'fa-pause-circle':!isPause}" aria-hidden="true"></i>
          </span>
        </div>
        <div class="player-btn">
      ...
      <div class="player-range">
        <el-slider v-model="current" @change="change"  @mousedown.native="mouseDown" :format-tooltip="formatTooltip" :min="0" :max="duration"></el-slider>
